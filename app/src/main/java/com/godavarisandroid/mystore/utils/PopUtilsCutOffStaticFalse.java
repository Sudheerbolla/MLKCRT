...
public class PopUtilsCutOffStaticFalse {
    ...
    public static void alertAddProductsDetails(final Context mContext, final Dialog firstDialog, final Dialog secondDialog) {
        ...
        mTxtQuantity.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopUtilsCutOffStaticFalse.alertDialogList(mContext, mDialogList, new DialogListInterface() {
                    @Override
        ...
        mTxtEndDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (TextUtils.isEmpty(mTxtStartDate.getText().toString().trim())) {
                    PopUtilsCutOffStaticFalse.alertDialog(mContext, "Please select start date first", null);
                } else {
...
//                    calendar.get(Calendar.HOUR) < cutOffTime;
//        }
//
//        return isReturn;
//    }
...
//
//            if (!nextDate.equalsIgnoreCase("")) {
//                isReturn = !nextDate.equalsIgnoreCase(new SimpleDateFormat("yyyy-MM-dd").format(tomorrowCalender.getTime())) || tomorrowCalender.get(Calendar.HOUR_OF_DAY) < cutOffCal.get(Calendar.HOUR_OF_DAY);
//            }
...
//    }
    ...
    public static boolean isSevenPmCrossedCorrect(Context context) {
        Calendar calendar = Calendar.getInstance();
    ...
    public static boolean checkDateTimeConditionCorrect(Context context, String nextDate) {
        Calendar calendar = Calendar.getInstance();
        boolean isReturn = false;
        if (!nextDate.equalsIgnoreCase("")) {
            Date todayDate = calendar.getTime();
