package com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview;
...
import com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview.format.ArrayWeekDayFormatter;
import com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview.format.DateFormatTitleFormatter;
import com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview.format.DayFormatter;
import com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview.format.MonthArrayTitleFormatter;
import com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview.format.TitleFormatter;
import com.godavarisandroid.mystore.utils.calenderutils.materialcalendarview.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    public MaterialCalendarView(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            if (leftMask == null) {
//                leftMask = getResources().getDrawable(R.drawable.back_selector);
            ...
            if (rightMask == null) {
//                rightMask = getResources().getDrawable(R.drawable.btn_next_selector);
    ...
    public class StateBuilder {
        ...
        public int getCalendarDisplayMode() {
            return calendarMode.visibleWeeksCount;
        }
