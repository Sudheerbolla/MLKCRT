...
public class OpensansAutoCompleteEditText extends AutoCompleteTextView {

    public OpensansAutoCompleteEditText(Context context) {
        super(context);
    }

    public OpensansAutoCompleteEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context, attrs, R.attr.font_type_opensans);
    }

    public OpensansAutoCompleteEditText(Context context, AttributeSet attrs, int defStyle) {
